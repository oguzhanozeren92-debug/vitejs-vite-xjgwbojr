...
export const FALLBACK_DESKTOP_MENU_ITEMS: DesktopMenuItem[] = [
  ...
  { screen: 'knowledgeHub', icon: '▧', label: 'Bilgi Merkezi', badge: 'YENİ' },
...
export const BASE_PLACEHOLDER_META: Partial<Record<Screen, PlaceholderMeta>> = {
  ...
  knowledgeHub: { title: 'Bilgi Merkezi', subtitle: 'Bilimsel makaleler, bitki bilgileri ve saha rehberlerini tek yerde incele.', icon: '📚', cards: ['Bilimsel Makaleler', 'Bitki Bilgileri', 'Hastalık & Zararlı Kaynakları'] },
