...
function readNotifications(): StoredNotification[] {
  ...
  try {
    ...
    // Eksik veri isteme kayıtları Görevlerim domainine taşınacak. Bildirim inbox'ı
    // kullanıcı aksiyonu isteyen bu eski kayıtları şimdiden göstermesin.
